...
.\.venv\Scripts\python.exe -m PyInstaller src/commands_automator/commands_automator_api.py -i src/commands_automator/ui/resources/Commands_Automator.ico -F --add-data "src/commands_automator/ui;ui" --add-data "src/commands_automator/config;config" --add-data "src/commands_automator/llm;llm" -w
