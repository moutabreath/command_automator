...
from .aplication_settings import application_settings
...
class Container(containers.DeclarativeContainer):
    ...
    config.mongo.connection_string.from_value(str(application_settings.mongo_uri))
    config.mongo.db_name.from_value(application_settings.mongo_db_name)
    config.mongo.application_collection_name.from_value(application_settings.job_application_collection_name)
